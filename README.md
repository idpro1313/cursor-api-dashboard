...
- **Структура (по логину и паролю):**
  ...
  - **Просмотр данных** (отдельные страницы с таблицами, копирование и сортировка): Дашборд, Участники и расходы, Данные в БД, Jira, Счета, Аудит.
...
- Ссылка **«Настройки и загрузки»** → страница входа → после входа: одна страница для всех загрузок (API, Jira CSV, PDF-счета), отдельные страницы для просмотра данных (дашборд, таблицы с копированием и сортировкой).
