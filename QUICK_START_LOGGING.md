...
Приложение **автоматически** пишет все логи в файл при запуске. Не требуется дополнительная настройка!
...
Логи будут автоматически записываться в `data/logs/app.log` и выводиться в консоль.
