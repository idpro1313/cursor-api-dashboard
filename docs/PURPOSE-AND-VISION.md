...
- **Что даёт:** загрузка PDF-счетов Cursor, парсинг таблицы позиций (Description, Qty, Unit price, Tax, Amount), сохранение в БД; просмотр списка счетов и позиций; удаление счёта с удалением лога; защита от дубликатов по хешу файла.
...
- **Что даёт:** отчёт по загруженным счетам (сводка по периодам биллинга и типам начислений); сверка «Usage Events vs позиции счетов» по периодам биллинга (цикл 6–5) с разницей в деньгах.
...
*Версия документа: 1.0, по состоянию функционала на момент составления.*
